...
import bg from '../../assets/Frame-new.jpg';
            ...
            >
                <div className="w-full h-full flex flex-col justify-between pt-[52px] pb-[52px] pl-[68px] pr-[68px]" style={{ background: 'rgba(24, 24, 27, 0.5)' }}>
                    <span className="flex gap-6">
                        ...
                        <h1 className="text-white text-[42px] font-bold">QasirKu</h1>
                    </span>
                    <div className="text-white">
                        <h1 className="text-[24px] font-medium mb-[24px]">“Quick setup, user-friendly, and perfect for my store. Highly recommend for any small business!”</h1>
                        <h1>Yahya - MuslilmStore Merchant Owner</h1>
                    </div>
                </div>
            </div>
